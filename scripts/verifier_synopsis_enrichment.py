...
def test_synopsis_enrichment(tmdb_id: int):
    ...
    with db_session() as session:
        ...
        if has_synopsis:
            ...
            print(f"   ⚠️  Synopsis manquant ou vide en BDD")
        ...
        if wiki_result.get("source") == "wikipedia":
            ...
            print(f"   ✅ Synopsis Wikipedia récupéré ({len(wiki_synopsis)} caractères)")
            ...
            print(f"   ❌ Impossible de récupérer le synopsis depuis Wikipedia")
