...
class TestMovieDataNormalization:
    ...
    def test_normalize_movie_data_missing_fields(self):
        ...
        incomplete_movie = {"title": "Test Film"}
...
class TestMovieListDisplay:
    ...
    def test_display_movie_list_with_films(
        self, mock_display_card, mock_st, sample_film_short
    ):
...
class TestFiltersCreation:
    ...
    @patch("components.components.st")
    def test_create_filters_sidebar_success(
        self, mock_st, mock_get, mock_api_response_genres, mock_api_response_directors
    ):
...
class TestAgentStatusDisplay:
    ...
    def test_display_agent_status_api_format(self, mock_st):
        ...
        status = {"step": "recherche", "status": "En cours..."}
